...
struct Employee {
    ...
    /*
     [ここのコメントが話の中心]
     インターンと新人以外の社員が顧客を削除する
     */
    func delete(user: User) {
        guard !intern, createdAt.check(byAdding: .year, value: -1) else {
...
let employee3 = Employee(id: 4, name: "新人", createdAt: "2022-12-30".date, intern: false)
